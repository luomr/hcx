<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\wamp\www\huichaoxuan\public/../application/admin\view\classified\add.html";i:1505879786;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo url('classified/add'); ?>">  
