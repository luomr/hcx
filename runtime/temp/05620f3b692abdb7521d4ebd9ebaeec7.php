<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\phpStudy\WWW\huichaoxuan\public/../application/home\view\news\news_list.html";i:1505958811;s:77:"D:\phpStudy\WWW\huichaoxuan\public/../application/home\view\public\r_nav.html";i:1506000259;s:77:"D:\phpStudy\WWW\huichaoxuan\public/../application/home\view\public\t_nav.html";i:1506001785;s:77:"D:\phpStudy\WWW\huichaoxuan\public/../application/home\view\public\b_nav.html";i:1506000235;}*/ ?>
<!DOCTYPE HTML>
<html>
	<head>
		<meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="__STATIC__/home/css/news_list.css">
	</head>
	<body>
		<!-- 侧边导航 -->
      <!DOCTYPE HTML>
      ...
      <div class="container">
        <ul>
          ...
          <li>
            <div class="row">
              <div class="col-md-2">
                <a href="/home/newsdet/index?id=<?php echo $vo['id']; ?>"><img src="__STATIC__/home/pic/new/<?php echo $vo['img']; ?>" class="img-responsive" alt="Cinque Terre"></a>
              </div>
              <div class="col-md-10">
                <h4><a href="/home/newsdet/index?id=<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></a></h4>
                <h6><?php echo date("Y-m-d H:i:s",$vo['time']); ?></h6>
                <p><a href="/home/newsdet/index?id=<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></a></p>
              </div>
            </div>
          </li>
