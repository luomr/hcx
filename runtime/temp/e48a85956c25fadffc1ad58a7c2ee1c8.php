<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\phpStudy\WWW\hcx\public/../application/admin\view\banner\edit.html";i:1505309121;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" enctype="multipart/form-data" action="<?php echo url('banner/edits'); ?>">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo $list['name']; ?>" name="name" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
