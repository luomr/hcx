<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\phpStudy\WWW\huichaoxuan\public/../application/home\view\recruit\recruitment.html";i:1505960351;s:77:"D:\phpStudy\WWW\huichaoxuan\public/../application/home\view\public\r_nav.html";i:1506000259;s:77:"D:\phpStudy\WWW\huichaoxuan\public/../application/home\view\public\t_nav.html";i:1506001785;s:77:"D:\phpStudy\WWW\huichaoxuan\public/../application/home\view\public\b_nav.html";i:1506000235;}*/ ?>
<!DOCTYPE HTML>
<html>
	<head>
		<title>企业招聘</title>
		...
		<link rel="stylesheet" type="text/css" href="__STATIC__/home/css/recruitment.css">
	</head>
	<body>
		<!-- 侧边导航 -->
			<!DOCTYPE HTML>
					...
					<div class="col-md-6">
		                <table class="table">
		                	<caption><h3>招贤纳士</h3></caption>
				                ...
				                <tr>
				                	<td><?php echo $job['explain']; ?></td>
				                </tr>
		                </table>
		              </div>
		              <div class="col-md-6">
		              	<div class="col-md-12"><h4>提交你的简历</h4></div>
						<form action="<?php echo url('recruitment/add'); ?>" method="post" enctype="multipart/form-data">
							<input type="hidden" name="id" value="<?php echo $job['id']; ?>">
							<input type="file" name="file" class="btn btn-default" value="">
							<br/><br/>
              				<input type="submit" value="提交简历" class="btn btn-default">
              				<br/><br/><br/><br/>
            		</div>
				</div>
			</div>
