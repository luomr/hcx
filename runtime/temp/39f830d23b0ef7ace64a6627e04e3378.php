<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\WWW\huichaoxuan\public/../application/admin\view\haibao\haibao.html";i:1505958184;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <button type="button" class="button border-yellow" onclick="window.location.href='<?php echo url('haibao/jump'); ?>'"><span class="icon-plus-square-o"></span> 添加产品</button>
    <form action="<?php echo url('haibao/search'); ?>" method="post">
