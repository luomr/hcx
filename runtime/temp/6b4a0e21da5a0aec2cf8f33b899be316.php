<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wamp\www\huichaoxuan\public/../application/admin\view\login\find.html";i:1505353727;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <script src="__STATIC__admin/js/pintuer.js"></script>  
</head>
<body>
<div class="bg"></div>
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <div style="padding:30px;"><input type="submit" class="button button-block bg-main text-big input-big" value="确认提交"></div>
            </div>
            </form>          
        </div>
    </div>
