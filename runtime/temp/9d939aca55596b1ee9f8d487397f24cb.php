<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\huichaoxuan\public/../application/admin\view\login\login.html";i:1505353405;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <div style="padding:30px;"><input type="submit" class="button button-block bg-main text-big input-big" value="登录"></div>
                 <div style="padding:10px;" class="text-center"><a href="<?php echo url('login/find'); ?>"><h4>找回密码</h4></a></div> 
            </div>
            </form>         
        </div>
    </div>
