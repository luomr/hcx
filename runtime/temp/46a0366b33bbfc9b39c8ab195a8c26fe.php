<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\phpStudy\WWW\hcx\public/../application/home\view\contact\contact.html";i:1505960380;s:69:"D:\phpStudy\WWW\hcx\public/../application/home\view\public\r_nav.html";i:1506000259;s:69:"D:\phpStudy\WWW\hcx\public/../application/home\view\public\t_nav.html";i:1506001785;s:69:"D:\phpStudy\WWW\hcx\public/../application/home\view\public\b_nav.html";i:1506000235;}*/ ?>
<!DOCTYPE HTML>
<html>
	<head>
		<title>联系我们</title>
		...
		<link rel="stylesheet" type="text/css" href="__STATIC__/home/css/contact.css">
	</head>
	<body>
		<!-- 侧边导航 -->
			<!DOCTYPE HTML>
		...
		<nav class="navbar-default" role="navigation">
			<div class="container">
				...
				<div class="col-md-12 text-center">
					<h1>CONTACT US</h1><h4>联系我们</h4>
				</div>
				<div class="col-md-12">
					<iframe src="map.html" width="100%" height="500px" frameborder="0" scrolling="no"></iframe>
				</div>
				<div class="col-md-4">
					<?php foreach($cominfo as $vo): ?>
					<p><h4><?php echo $vo['name']; ?></h4></p>
					<br/>
					<p>地址: <?php echo $vo['address']; ?></p>
					<p>电话: <?php echo $vo['phone']; ?></p>
					<p>传真: <?php echo $vo['fax']; ?></p>
					<p>邮箱: <?php echo $vo['email']; ?></p>
					<?php endforeach; ?>
				</div>
				<div id="kong" class="col-md-12"></div>
			</div>
		</nav>
			<!-- 页尾 -->
			<!DOCTYPE HTML>
